---
name: docs
description: Retrieve project documentation. Use when the user asks about
  APIs, specs, runbooks, configs, or "how do we do X here". Trigger words: docs,
  our spec, runbook, design doc.
---
